...
_C.MEGA.ROIHEADS_OUT_DIM = 2048
_C.MEGA.VAE_LATENT_DIM = 1024
...
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.TEMPERATURE = 0.2
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.LOSS_WEIGHT = 0.5
...
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.IOU_THRESHOLD = 0.8
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.LOSS_VERSION = 'V1'
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.REWEIGHT_FUNC = 'none'

_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.USE_COSSIM = True
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.COSSIM_SCALE = 20
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.USE_BIAS = False
...
# Gradient Scale
_C.MEGA.ENABLE_GRADIENT_SCALE = False
_C.MEGA.RPN_GRADIENT_SCALE = 1.0
_C.MEGA.ROIHEADS_GRADIENT_SCALE = 1.0
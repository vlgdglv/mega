...
class MegaEnhancedRCNN(nn.Module):
    """
    From Generalized R-CNN. Any models that contains the following three components:
    ...
    def inference(
        ...
        if do_postprocess:
            ...
            results = MegaEnhancedRCNN._postprocess(results, batched_inputs, images.image_sizes)
        return results
